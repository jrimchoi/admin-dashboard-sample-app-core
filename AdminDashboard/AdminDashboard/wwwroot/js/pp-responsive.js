var ppFactory = (function() {
	...
	PPFactory.prototype.runProtocol = function(protocol, params, resultId,fnCallback) {
		...
		// 220420 JHJ //
		if(server == "https://elndev.daesang.com"){
			server += ":9943";
		}
	...
	// 220427 JHJ 에러 및 모든 Alert 무시
	PPFactory.prototype.runProtocol_NoAlert = function(protocol, params, resultId,fnCallback) {
		var launchJobData = $.extend(
			params,
			{
				$protocol: protocol,
		...
		// 220617 JHJ
		server = "https://elndev.daesang.com:9943";
